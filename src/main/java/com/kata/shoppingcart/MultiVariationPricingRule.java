 ...
 */
@Order(1)
public final class MultiVariationPricingRule implements PricingRule {
    ...
    public static class MultiItemPricingRuleBuilder {
        ...
        public MultiVariationPricingRule forPrice(final long price) {
            return new MultiVariationPricingRule(item, price, special);
        }
    ...
    private MultiVariationPricingRule(final Item item, final long price, final int special) {
        this.item = item;
        this.price = price;
        this.special = special;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MultiVariationPricingRule other = (MultiVariationPricingRule) obj;
        if (item == null) {
            if (other.item != null)
                return false;
